...
class MarcaDao:
        ...
        try:
            ...
            if marcaEncontrada:
                return {
                    ...
                    }  # Retornar los datos de la tabla marca
            else:
                return None # Retornar None si no se encuentra la tabla marca
        except Exception as e:
            app.logger.error(f"Error al obtener el marca: {str(e)}")
            return None
    ...
    def guardarMarca(self,descripcion):
        ...
        # Si algo fallo entra aqui
            ...
            app.logger.error(f"Error al insertar el marca: {str(e)}")
    ...
    def updateMarca(self, id,descripcion):
        ...
        try:
            ...
            app.logger.error(f"Error al actualizar el marca: {str(e)}")
            con.rollback()
            return False
    ...
    def deleteMarca(self, id):
        ...
        try:
            ...
            app.logger.error(f"Error al eliminar el marca: {str(e)}")
            con.rollback()
            return False
