...
class SexoDao:
    ...
    def getSexos(self):
        ...
        try:
            ...
            return [{'id': sexo[0], 'descripcion_sexo': sexo[1]} for sexo in sexos]
    ...
    def getSexoById(self, id):
        ...
        try:
            ...
            if sexoEncontrada:
                return {
                        "id": sexoEncontrada[0],
                        "descripcion_sexo": sexoEncontrada[1]
    ...
    def guardarSexo(self, descripcion_sexo):

        insertSexoSQL = """
        INSERT INTO sexos(descripcion_sexo) VALUES(%s) RETURNING id
        """
        ...
        # Ejecucion exitosa
        try:
            cur.execute(insertSexoSQL, (descripcion_sexo,))
    ...
    def updateSexo(self, id, descripcion_sexo):

        updateSexoSQL = """
        UPDATE sexos
        SET descripcion_sexo=%s
        WHERE id=%s
        """
        ...
        try:
            cur.execute(updateSexoSQL, (descripcion_sexo, id,))
