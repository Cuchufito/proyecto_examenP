...
class OcupacionDao:
    ...
    def getOcupaciones(self):
        ...
        ocupacionSQL = """
        SELECT id, descripcion_ocupacion
        FROM ocupaciones
        """
        # objeto conexion
        conexion = Conexion()
        ...
        try:
            ...
            return [{'id': ocupacion[0], 'descripcion_ocupacion': ocupacion[1]} for ocupacion in ocupaciones]
        ...
        try:
            ...
            if ocupacionEncontrada:
                return {
                        ...
                        "descripcion_ocupacion": ocupacionEncontrada[1]
    ...
    def guardarOcupacion(self, descripcion_ocupacion):

        insertOcupacionSQL = """
        INSERT INTO ocupaciones(descripcion_ocupacion) VALUES(%s) RETURNING id
        """
        ...
        # Ejecucion exitosa
        try:
            cur.execute(insertOcupacionSQL, (descripcion_ocupacion,))
    ...
    def updateOcupacion(self, id, descripcion_ocupacion):

        updateOcupacionSQL = """
        UPDATE ocupaciones
        SET descripcion_ocupacion=%s
        WHERE id=%s
        """
        ...
        try:
            cur.execute(updateOcupacionSQL, (descripcion_ocupacion, id,))
