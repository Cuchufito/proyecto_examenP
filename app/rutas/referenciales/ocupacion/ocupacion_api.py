...
def addOcupacion():
    ...
    campos_requeridos = ['descripcion_ocupacion']
    ...
    try:
        descripcion_ocupacion = data['descripcion_ocupacion'].upper()
        ocupacion_id = ocupaciondao.guardarOcupacion(descripcion_ocupacion)
        if ocupacion_id is not None:
            return jsonify({
                'success': True,
                'data': {'id': ocupacion_id, 'descripcion_ocupacion': descripcion_ocupacion},
                'error': None
            }), 201
        else:
...
def updateOcupacion(ocupacion_id):
    ...
    try:
        if ocupaciondao.updateOcupacion(ocupacion_id, descripcion_ocupacion.upper()):
            return jsonify({
                'success': True,
                'data': {'id': ocupacion_id, 'descripcion_ocupacion': descripcion_ocupacion},
                'error': None
