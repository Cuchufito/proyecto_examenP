...
def addEstadoCivil():
    ...
    campos_requeridos = ['descripcion_civil']
    ...
    try:
        descripcion_civil = data['descripcion_civil'].upper()
        estadocivil_id = estacivdao.guardarEstadoCivil(descripcion_civil)
        if estadocivil_id is not None:
            return jsonify({
                'success': True,
                'data': {'id': estadocivil_id, 'descripcion_civil': descripcion_civil},
                'error': None
            }), 201
        else:
...
def updateEstadoCivil(estadocivil_id):
    ...
    descripcion_civil = data['descripcion_civil']
    try:
        if estacivdao.updateEstadoCivil(estadocivil_id, descripcion_civil.upper()):
            return jsonify({
                'success': True,
                'data': {'id': estadocivil_id, 'descripcion_civil': descripcion_civil},
                'error': None
