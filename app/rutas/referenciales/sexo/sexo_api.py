...
def addSexo():
    ...
    campos_requeridos = ['descripcion_sexo']
    ...
    try:
        descripcion_sexo = data['descripcion_sexo'].upper()
        sexo_id = sexodao.guardarSexo(descripcion_sexo)
        if sexo_id is not None:
            return jsonify({
                'success': True,
                'data': {'id': sexo_id, 'descripcion_sexo': descripcion_sexo},
                'error': None
            }), 201
        else:
...
def updateSexo(sexo_id):
    ...
    descripcion_sexo = data['descripcion_sexo']
    try:
        if sexodao.updateSexo(sexo_id, descripcion_sexo.upper()):
            return jsonify({
                'success': True,
                'data': {'id': sexo_id, 'descripcion_sexo': descripcion_sexo},
                'error': None
